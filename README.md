...
Here is an example using the `YCrCb`(Y=luma/brightness, CrCb=red-difference, blue-difference chroma/color components) color space and HOG parameters of `orientations=9`, `pixels_per_cell=(8, 8)` and `cells_per_block=(2, 2)`:
